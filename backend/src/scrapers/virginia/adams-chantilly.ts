...
export async function scrape(browser: Browser): Promise<PrayerTimeTable> {
  ...
  daySchedule.jummah = [
    {
      confidence: 100,
      iqamah: stringToDateTime("11:30", "HH:mm", "America/New_York")
    },
    {
      confidence: 100,
      iqamah: stringToDateTime("12:30", "HH:mm", "America/New_York")
    },
    {
      confidence: 100,
      iqamah: stringToDateTime("13:30", "HH:mm", "America/New_York")
    }
  ];
